...
// Rule include host that points to a backend service name
type IngressRule struct {
	Host           string         `json:"host"`
	BackendService BackendService `json:"backend,omitempty"`
}
type BackendService struct {
	BackendServiceName string `json:"serviceName,omitempty"`
	BackendServicePort int    `json:"servicePort,omitempty"`
}
